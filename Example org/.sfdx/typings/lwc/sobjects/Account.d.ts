...
declare module "@salesforce/schema/Account.IsBuyer" {
...
declare module "@salesforce/schema/Account.Match_Billing_Address__c" {
  const Match_Billing_Address__c:boolean;
  export default Match_Billing_Address__c;
}
