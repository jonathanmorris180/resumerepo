...
declare module "@salesforce/schema/ContactChangeEvent.Prequalified__c" {
  const Prequalified__c:boolean;
  export default Prequalified__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Loan_Amount__c" {
  const Loan_Amount__c:number;
  export default Loan_Amount__c;
}
...
declare module "@salesforce/schema/ContactChangeEvent.Location__Latitude__s" {
  const Location__Latitude__s:number;
  export default Location__Latitude__s;
}
declare module "@salesforce/schema/ContactChangeEvent.Location__Longitude__s" {
  const Location__Longitude__s:number;
  export default Location__Longitude__s;
}
declare module "@salesforce/schema/ContactChangeEvent.Location__c" {
